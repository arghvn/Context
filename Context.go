//Note: This exercise is very related to the topic of channels
// and goroutines and is done only to get acquainted with the
// http protocol, so in the future, sections related to channels and goroutines will be developed.
